...
export default function App() {
    ...
    const generatePrompts = useCallback(() => {
        ...
        const jsonObject = {
            ...
            prompt: eng,
            negative_prompt: "bad quality, distorted, blurry, watermark, text overlay, bad anatomy, deformed, ugly, pixelated, low resolution, static camera (if movement requested), shaky camera (if static requested)",
